...
export default function AdminDashboard() {
  ...
  const query = trpc.admin.dashboard.useQuery({ period, evaluationSetId: selectedSetId === "" ? null : Number(selectedSetId) });
