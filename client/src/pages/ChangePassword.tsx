...
export default function ChangePassword() {
  ...
  const change = trpc.auth.changePassword.useMutation({ onSuccess: async () => { await refresh(); toast.success("Şifreniz güncellendi."); setLocation(user?.role === "EVALUATOR" ? "/evaluator/dashboard" : "/admin/dashboard"); }, onError: error => toast.error(error.message) });
